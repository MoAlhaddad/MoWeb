        ...
        >
          ...
          <div className="trm-mc-header">
            <div className="trm-avatar-frame trm-mb-20">
              <img className="trm-avatar" src="/img/profilemo.jpg" alt="Avatar" />
              <div className="trm-dot" />
            </div>
            <h5 className="trm-name trm-mb-15">Mohamad Alhaddad </h5>
          ...
          <ul className="trm-table trm-mb-20">
            ...
            <li>
              ...
              <div className="trm-label trm-label-light">USA</div>
            </li>
            {/* city */}
            <li>
              <div className="trm-label">City:</div>
              <div className="trm-label trm-label-light">Port Saint Lucie</div>
            </li>
            {/* age */}
            <li>
